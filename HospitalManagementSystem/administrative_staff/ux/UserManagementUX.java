...
public class UserManagementUX extends JFrame {
    ...
    public UserManagementUX() {
        setTitle("User Management"); setSize(960, 560); setLocationRelativeTo(null); setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        buttons.add(backButton); buttons.add(addButton); buttons.add(updateButton);
        buttons.add(deleteButton); buttons.add(clearButton); buttons.add(refreshButton);
