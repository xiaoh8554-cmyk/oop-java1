...
public class Patient extends User {
    ...
    public Patient(String id, String email, String password, String fullName, String phoneNumber,
        ...
        this.emergencyRelationship = (emergencyRelationship != null && !emergencyRelationship.trim().isEmpty())
    ...
    public Patient(String id, String email, String password, String fullName, String phoneNumber,
        ...
        this(id, email, password, fullName, phoneNumber, dateOfBirth, gender, bloodGroup, emergencyContact, "parents",
