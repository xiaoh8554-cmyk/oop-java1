...
public class PatientPrescriptionFeedbackUX extends JFrame {
    ...
    protected final JTextField visitField = new JTextField(12);
    ...
    public PatientPrescriptionFeedbackUX() {
        ...
        // TAB 1: Prescriptions
        tabs.addTab("My Digital Prescriptions", new JScrollPane(prescriptionTable));
        ...
        form.setBorder(BorderFactory.createTitledBorder("Submit Rating & Comments for Doctor / Clinic Visit"));
        ...
        g.gridx = 0; g.gridy = 0;
        form.add(new JLabel("Doctor ID (e.g. D001):"), g);
        g.gridx = 1;
        ...
        g.gridx = 0; g.gridy = 2;
        form.add(new JLabel("Clinic Visit / Appt ID (Optional):"), g);
        g.gridx = 1;
        form.add(visitField, g);
